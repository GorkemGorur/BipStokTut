...
Public Class StokGirisFisiRaporu
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "StokGirisFisiRaporu.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BipStokTut.StokGirisFisiRaporu.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_FaturaKayitNoP() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedStokGirisFisiRaporu
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StokGirisFisiRaporu = New StokGirisFisiRaporu()
        rpt.Site = Me.Site
        Return rpt
    End Function
